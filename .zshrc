...
export ZSH=/Users/crissman/.oh-my-zsh
...
alias zrc='vim ~/.zshrc; source ~/.zshrc; conup'
alias vrc='vim ~/.vimrc; conup'
alias cc='cdc; python setup.py build install > /dev/null; flake8; cd docs; make clean; make html; cd -2'
